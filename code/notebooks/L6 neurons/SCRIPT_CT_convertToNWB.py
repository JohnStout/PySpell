...
for animali in all_animals: # loop over each animal
    ...
    suite2p_path  = [os.path.join(datafolder,i,'suite2p') for i in seds_sessions if 'x' not in i and if 'nwb' not in i] # define suite2p paths for each recorded session
