...
# training sessions
from rootfun import dropbox_root
training_dir = os.path.join(dropbox_root(),'OtherData', 'ClassifierBuildSuite2p')
training_sessions = [i for i in os.listdir(training_dir) if '.m' not in i]
